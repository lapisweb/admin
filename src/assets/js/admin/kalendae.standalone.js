...
console.log(options,' options')
      ...
      while (j--) {
        ...
        util.make('button', {'class':classes.previousMonth,type:classes.type}, $title);          //previous button
        util.make('a', {'class':classes.nextYear}, $title);               //next button
        util.make('button', {'class':classes.nextMonth,'ref':classes.nextdata,type:classes.type}, $title);              //next button
      ...
      util.addEvent($container, 'mousedown', function (event, target) {
        ...
        var clickedDate;
        document.getElementsByClassName('k-btn-previous-month')[0].addEventListener('click',pre)
        function pre() {
          console.log(document.getElementsByClassName('k-caption')[0].innerHTML,"document.getElementsByClassName('k-caption')[0].innerHTML")
          let month1=document.getElementsByClassName('k-btn-previous-month')
          if(document.getElementsByClassName('k-caption')[0].innerHTML=="January, 2019"||document.getElementsByClassName('k-caption')[0].innerHTML=="January, 2018" ){
            console.log(document.getElementsByClassName('k-caption')[0].innerHTML,"document.getElementsByClassName('k-caption')[0].innerHTML")
            // .kalendae .k-btn-previous-month
            console.log('5555555')
            month1[0].style.display="none"
            // month1[0].disabled=true
            // console.log(month1[0],'cccccccccccccc')
          }else{
            console.log('66666666')
            // let month1=document.getElementsByClassName('k-btn-next-month')
            month1[0].style.display=""
            // month1[0].disabled=false
          }
          let month2=document.getElementsByClassName('k-btn-next-month')
          if(document.getElementsByClassName('k-caption')[0].innerHTML=="December, 2019"||document.getElementsByClassName('k-caption')[0].innerHTML=="December, 2018" ){
            // console.log()
            month2[0].style.display="none"
            console.log('1111111111')
            // console.log(month2,'month2')
            // month2[0].disabled=true
          }else{
            console.log('222222222')
            // let month2=document.getElementsByClassName('k-btn-next-month')
            month2[0].style.display=""
            // month2[0].disabled=false
          }
        }
        document.getElementsByClassName('k-btn-next-month')[0].addEventListener('click',next)
        function next() {
          console.log(document.getElementsByClassName('k-caption')[0].innerHTML,"document.getElementsByClassName('k-caption')[0].innerHTML")
          let month1=document.getElementsByClassName('k-btn-previous-month')
          if(document.getElementsByClassName('k-caption')[0].innerHTML=="January, 2019"||document.getElementsByClassName('k-caption')[0].innerHTML=="January, 2018" ){
        ...
        if (util.hasClassName(target, classes.nextMonth)) {
          ...
          if (!self.disableNext && self.publish('view-changed', self, ['next-month']) !== false) {
            ...
            // let month1=document.getElementsByClassName('k-btn-previous-month')
            // console.log(document.getElementsByClassName('k-caption')[0].innerHTML,"document.getElementsByClassName('k-caption')[0].innerHTML")
            // if(document.getElementsByClassName('k-caption')[0].innerHTML=="November, 2017" ){
            //   console.log(document.getElementsByClassName('k-caption')[0].innerHTML,"document.getElementsByClassName('k-caption')[0].innerHTML")
            //   // .kalendae .k-btn-previous-month
            //   console.log('5555555')
            //   month1[0].style.display="none"
            ...
            // }
            // let month2=document.getElementsByClassName('k-btn-next-month')
            // if(document.getElementsByClassName('k-caption')[0].innerHTML=="November, 2018" ){
            //   // console.log()
            //   month2[0].style.display="none"
            //   console.log('1111111111')
            //   // console.log(month2,'month2')
          ...
          if (!self.disablePreviousMonth && self.publish('view-changed', self, ['previous-month']) !== false) {
            ...
            // let month1=document.getElementsByClassName('k-btn-previous-month')
            // console.log(document.getElementsByClassName('k-caption')[0].innerHTML,'document.getElementsByClassName(\'k-caption\')[0].innerHTML')
            // if(document.getElementsByClassName('k-caption')[0].innerHTML=="February, 2018" ){
            //   // .kalendae .k-btn-previous-month
            ...
            // }
            // let month2=document.getElementsByClassName('k-btn-next-month')
            // if(document.getElementsByClassName('k-caption')[0].innerHTML=="February, 2019" ){
            //   // console.log()
            ...
            // let asd=document.getElementsByClassName('k-days')
            // console.log(self,'sssssssssssss')
            // asd[0].location.reload()
          }
          ...
          if (!self.disableNext && self.publish('view-changed', self, ['next-year']) !== false) {
            // if(document.getElementsByClassName('k-caption')[0].innerHTML=="January, 2018" || document.getElementsByClassName('k-caption')[0].innerHTML=="January, 2019"){
            //   // .kalendae .k-btn-previous-month
            //   let month1=document.getElementsByClassName('k-btn-previous-month')
            ...
            //   month1[0].disabled=false
            // }
            // if(document.getElementsByClassName('k-caption')[0].innerHTML=="November, 2018" || document.getElementsByClassName('k-caption')[0].innerHTML=="November, 2019"){
            //   // console.log()
            //   let month2=document.getElementsByClassName('k-btn-next-month')
            //   console.log(month2,'month2')
            //   month2[0].disabled=true
      ...
      draw : function draw() {
        ...
        do {
          ...
          do {
            ...
            if (day.clone().startOf('day').yearDay() === getTodayYearDate()) klass.push();
