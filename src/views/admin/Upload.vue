...
<script>
  ...
  export default {
    props: {
      ...
      url: {
        type: String,
        'default': 'http://www.laison.com:8080/fileUpload.do'
      },
      // 其他要上传文件附带的数据，对象格式
      params: {
        type: Object,
    ...
    methods: {
      ...
      startZoomSub(e) {
        ...
        function zoom() {
          if (scale.zoomSubOn) {
            let range = scale.range <= -100 ? 0 : --scale.range;
            that.zoomImg(range);
            setTimeout(function() {
              zoom();
            }, 60);
      ...
      upload() {
        ...
        new Promise(function(resolve, reject) {
          ...
          client.open('POST', 'http://api.laison.com:8080/fileUpload.do', true,console.log(url,'111111111)'));
...
<style scoped>
  ...
  .vue-image-crop-upload .vicp-wrap .vicp_title {
    display: block;
    height: 50px;
    background: #7dcbb9;
    line-height: 50px;
  ...
  .vue-image-crop-upload .vicp-wrap .vicp_title span {
    float: left;
    margin-left: 10px;
  }
  ...
  .vicp-step1 .vicp-drop-area .vicp-icon1 {
    display: block;
    margin: 0 auto 6px;
    width: 42px;
    height: 42px;
  ...
  .vicp-step1 .vicp-drop-area .vicp-icon1 .vicp-icon1-arrow {
    display: block;
    margin: 0 auto;
    width: 0;
    height: 0;
  ...
  .vicp-step1 .vicp-drop-area .vicp-icon1 .vicp-icon1-body {
    display: block;
    width: 12.6px;
    height: 14.7px;
    margin: 0 auto;
  ...
  .vicp-step1 .vicp-drop-area .vicp-icon1 .vicp-icon1-bottom {
    -webkit-box-sizing: border-box;
    box-sizing: border-box;
    display: block;
    height: 12.6px;
  ...
  .vicp-step1 .vicp-drop-area .vicp-no-supported-hint {
    display: block;
    position: absolute;
    top: 0;
    left: 0;
  ...
  .vicp-step1 .vicp-drop-area:hover {
    cursor: pointer;
  ...
  .vue-image-crop-upload .vicp-wrap .vicp-step2 .vicp-crop .vicp-crop-left .vicp-img-container .vicp-img-shade.vicp-img-shade-3 {
    left: 80px;
    top: 0;
  }

  .vue-image-crop-upload .vicp-wrap .vicp-step2 .vicp-crop .vicp-crop-left .vicp-img-container .vicp-img-shade.vicp-img-shade-4 {
    bottom: 0;
    left: 80px;
  }
  ...
  .vue-image-crop-upload .vicp-wrap .vicp-operate button {
    width: 140px;
    height: 36px;
    background: #06b38a;
    outline: none;
